...
config = {
    ...
    'separate': {
        'model_name': 'unet',
        'model_path': '/Users/Claudia/Desktop/suxume_code/SongAnalysis/Hybrid-Net/models/unet.py',
        'model': {
            'n_layers': 5,
        },
        'spec': {
    ...
    'lyrics': {
        # Add your lyrics model configuration here
    },
    'beat': {
        'model_name': 'beat',
        'model_path': '/Users/Claudia/Desktop/suxume_code/SongAnalysis/Hybrid-Net/models/beat_net.py',
        'model': {
    ...
    'chord': {
        'model_name': 'chord',
        'model_path': '/Users/Claudia/Desktop/suxume_code/SongAnalysis/Hybrid-Net/models/chord_net.py',
        'model': {
            # Example, update based on your model configuration
        }
    },
    'segment': {
        'model_name': 'segment',
        'model_path': '/Users/Claudia/Desktop/suxume_code/SongAnalysis/Hybrid-Net/models/segment_net.py',
        'model': {
            # Example, update based on your model configuration
        }
    },
    'pitch': {
        'model_name': 'pitch',
        'model_path': '/Users/Claudia/Desktop/suxume_code/SongAnalysis/Hybrid-Net/models/pitch_net.py',
        'model': {
            # Example, update based on your model configuration
        }
    },
...
result, inst_waveforms = transcription.transcribe('/Users/Claudia/Desktop/suzume/iseeu6/iseeu.wav', device='cpu')
